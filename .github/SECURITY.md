...
If you discover a security vulnerability in this project, please raise an issue on [GitHub Issues](https://github.com/SiegeSailor/Smarty-Notebook-Collection/issues). We take all security reports seriously and will respond promptly to your report. Once the vulnerability is confirmed, we will take the necessary steps to address it, including notifying affected users and releasing a patch.
